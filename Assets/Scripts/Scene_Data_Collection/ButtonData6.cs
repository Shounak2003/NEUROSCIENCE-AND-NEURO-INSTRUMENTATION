...
public class ButtonData6 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        YesButton.onClick.AddListener(() => OnOptionButtonClicked("Yes"));
    ...
    private void SubmitForm()
    {
        ...
        form.AddField("entry.625943704", selectedOption); // Option field ID
        //form.AddField("entry.36880176", selectedOption); // Option field ID
